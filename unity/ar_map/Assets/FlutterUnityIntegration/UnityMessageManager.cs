...
public class UnityMessageManager : MonoBehaviour
{
    ...
    public void InitLocationData(string jsonData)
    {
        print("InitLocationDataInitLocationDataInitLocationData" +
            "\n" +
            "InitLocationDataInitLocationDataInitLocationDataInitLocationData " + jsonData);
        LocationDataManager.GetInstance().AttachData(jsonData);
    }
